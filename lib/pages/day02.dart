  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Container(
        child: Carousel(
          children:
              _weatherData.map((city) => WeatherPage(cityData: city)).toList(),
        ),
      ),
...
class WeatherPage extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    List<Widget> hourViewList = cityData['hours']
        .map<Widget>((hourElem) => Container(
              width: 55.0,
              alignment: Alignment.center,
              child: Column(
                children: <Widget>[
                  Container(
                      child: Text(hourElem['time'],
                          style: TextStyle(
                              color: Color(0xFFFFFFFF), fontSize: 15.0))),
                  Expanded(
                      child: Icon(
                          IconData(int.parse(hourElem['icon']),
                              fontFamily: 'FlutterIcon'),
                          color: Color(int.parse(hourElem['color'])))),
                  Container(
                      child: Text(hourElem['degree'],
                          style: TextStyle(
    ...
    List<Widget> dayViewList = cityData['days']
        .map<Widget>((dayElem) => Container(
              height: 28.0,
              padding: EdgeInsets.only(left: 20.0, right: 20.0),
              child: Row(
                children: <Widget>[
                  Container(
                      child: Text(dayElem['day'],
                          style: TextStyle(
                              color: Color(0xFFFFFFFF), fontSize: 15.0))),
                  Expanded(
                      child: Container(
                          alignment: Alignment.center,
                          child: Icon(
                              IconData(int.parse(dayElem['icon']),
                                  fontFamily: 'FlutterIcon'),
                  ...
                  Container(
                    ...
                    Container(
                        ...
                        child: Text('${dayElem['low']}',
                            style: TextStyle(
                                color: Color(0xFFFFFFFF), fontSize: 16.0))),
                    Container(
                        width: 35.0,
                        alignment: Alignment.centerRight,
                        child: Text('${dayElem['high']}',
                            style: cityData['night']
                                ? TextStyle(
                                    color: Color(0xFFAAAAAA), fontSize: 16.0)
                                : TextStyle(
                                    color: Color(0xFFEEEEEE), fontSize: 16.0))),
                  ]))
                ],
              ),
            ))
            ...
            child: new IntrinsicHeight(
              ...
              decoration: BoxDecoration(
                  image: DecorationImage(
                      image: AssetImage('images/${cityData['bg']}'),
                      fit: BoxFit.cover)),
              child: Container(
                  ...
                  children: <Widget>[
                      ...
                      child: Column(
                        children: <Widget>[
                          Text(
                            cityData['city'],
                            style: TextStyle(
                                color: Color(0xFFFFFFFF), fontSize: 32.0),
                          ),
                          Text(cityData['abs'],
                              style: TextStyle(
                                  color: Color(0xFFFFFFFF), fontSize: 15.0)),
                        ...
                        children: <Widget>[
                              ...
                              children: <Widget>[
                                Row(
                                  ...
                                  children: <Widget>[
                                    Container(
                                        width: 60.0,
                                        child: Text(cityData['today']['week'],
                                            style: TextStyle(
                                                color: Color(0xFFFFFFFF),
                                                fontSize: 18.0,
                                                fontWeight: FontWeight.w400))),
                                ...
                                Row(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Container(
                                      width: 30.0,
                                      child: Text('${cityData['today']['high']}',
                                          style: TextStyle(
                                              color: cityData['night']
                                                  ? Color(0xFFAAAAAA)
                                                  : Color(0xFFEEEEEE),
                                              fontSize: 18.0,
                                              fontWeight: FontWeight.w200)),
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              border: Border(
                                  top: BorderSide(
                                      color: Color(0xB3FFFFFF), width: 0.5),
                                  bottom: BorderSide(
                                      color: Color(0xB3FFFFFF), width: 0.5)),
                            ),
                            child: ListView(
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        bottom:
                            BorderSide(color: Color(0xB3FFFFFF), width: 0.5),
                      )),
                      child: Text(
                        cityData['info'],
                        style:
